...
insert into department values(100 ,' Finance' ,   108 ,700 )
...
(107,'Diana      ','Lorentz   ','DLORENTZ','590.423.5567','2007-02-07','IT_PROG', 4200.0,0.00,103, 60),
(108,'Nancy      ','Greenberg ','NGREENBE','515.124.4569','2002-08-17','FI_MGR ',12008.0,0.00,101,100),
...
constraint q7 foreign key (DEPARTMENT_ID) references department(DEPARTMENT_ID))
